...
<img src="Media/prototype_sketch_1.jpeg" alt="Description of image" width="400" height="600">
...
<img src="Media/prototype_Sketch.jpeg" alt="Description of image" width="400" height="600">
...
1. Refine the Animation: Adjust the frame rate (frames per second) for speed and set the animation to loop.
...
1. Develop Unique Mechanics (Minigames):
...
1. Achieving the "2.5D" Effect (After Effects)
...
1. Creating Animated Background Effects
...
1. Danganronpa-Specific Techniques
...
So I was thinking of the ideas tHa i got during the ideation workshop. I had a small starting idea. This idea was not even something I had in mind for a while but intsead I got the idea the class riht before (my 1:15 to 5:15 class, class 498 generative AI with Gabriel)
...
its also a very easy way to make it more pg and have it more like a maid cafe but with intrument or like a host club.

but the idea of the characters having instrument perks and stats and personality based on the original character like a clarinet would be the nerd girl or like the acordian would be the very tall shy girl that kind of curls on herself, like she hunches a bit her back to make herelf shorter which this physicality has to do with how you strech and compress and acordian.

very dating,visual novel,

i was thinking of a bar or cafe, maybe nighclub would be better or you could have different staff base on day and night shift
